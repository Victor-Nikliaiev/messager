...
from assets.ui.ui_emojiPicker import Ui_Form
from assets.emoji.QCustomTipOverlay import QCustomTipOverlay
...
class QCustomEmojiPicker(QCustomTipOverlay):
    ...
    def __init__(
        ...
        jsonFile = os.path.abspath(os.path.join(str(current_script), "emojis.json"))
    ...
    def mousePressEvent(self, event: QtGui.QMouseEvent):
        if event.button() == QtCore.Qt.LeftButton:
            ...
            self.offset = (
                event.pos()
            )  # Store the relative position of the mouse to the window
    ...
    class __QHoverPushButton(QtWidgets.QPushButton):
        ...
        def enterEvent(self, a0: QtCore.QEvent) -> None:
            ...
            self.parent_emoji_picker.form.form.emoji_image_label.setFont(
                QtGui.QFont("Noto Color Emoji")
            )
        ...
        def updateTargetText(self):
            ...
            # Check if the target widget is a QTextEdit or QPlainTextEdit
                ...
                target_widget, (QtWidgets.QTextEdit, QtWidgets.QPlainTextEdit)
            ):
